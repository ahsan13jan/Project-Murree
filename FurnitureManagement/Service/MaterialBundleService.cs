    ...
    static class MaterialBundleService
    {
        public static List<MaterialBundle> MaterialBundles( int articleId )
        {
            ...
            try {
                ...
                bundles[4].MaterialBundleItems.ToList().ForEach(x => x.Quantity = Math.Round((decimal)(x.Quantity * MainainenceHelper.quantityRatio(articleId)), 3));
            ...
            {
                return new List<MaterialBundle>();
            }
        ...
        public static bool IsBundleAvailable(int Id , int articleId , decimal Multipler = 1 )
        {
            ...
            try
            {
                ...
                if (Id == 5)
                {
                    Bundle.MaterialBundleItems.ToList().ForEach(x => x.Quantity = (decimal)Math.Round((double)(x.Quantity * MainainenceHelper.quantityRatio(articleId) * Multipler), 3));
                }
